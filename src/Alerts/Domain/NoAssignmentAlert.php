...
class NoAssignmentAlert extends Alert
{
    ...
    ): NoAssignmentAlert
    {
        return new self(
            ...
            $status,
            $result,
            Category::createPlanning(),
            Type::createNoAssignmentAlert(),
            $fact,
            $created_at,
            $modified_at,
    ...
    public static function createFromArray(array $alert): NoAssignmentAlert
    {
        return new self(
            $alert['id'],
            $alert['service_id'],
